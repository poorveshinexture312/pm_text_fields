...
/// my properties
abstract class _PMTextFieldTheme extends InputDecorationTheme {
  const _PMTextFieldTheme({
    super.hintStyle,
...
class BorderlessTextTheme extends _PMTextFieldTheme {
  BorderlessTextTheme({
...
class FilledOrOutlinedTextTheme extends _PMTextFieldTheme {
